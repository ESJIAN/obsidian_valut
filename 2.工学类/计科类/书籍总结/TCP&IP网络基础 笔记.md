...
如下图所示：  
![这里写图片描述](https://img-blog.csdn.net/20180529183822818)  
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210701091317951.png)

换一种形式展示，如下图所示：  
![这里写图片描述](https://img-blog.csdn.net/20180529182740527)  
...
![img](https://img-blog.csdn.net/20150126225341078)

由于比较常见， 所以还是复习了一下， 至于为什么需要DNS, 你只要想想你经常使用的www.baidu.com就可以了， 这个可比其ip
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210704153331929.png)
...
| CNAME | 5   | 别名记录，主机别名对应的规范名称，常用于CDN加速                                                       |
...
Q：域名解析中，A记录、CNAME、MX记录、NS记录的区别和联系?
A： 都是区域（Zone）数据库文件都是由资源记录。
